# Exercício 03 — Jornada do Herói (Cliente como Herói)
## Método NOW / NOW OX
...
> "Um método. 48 horas. Uma startup no ar. Sem código. Sem equipa. A janela está aberta NOW."
...
- "Eu não sou técnico"
- "48 horas? Impossível"
- "Quem é esta pessoa sequer? Nem mostra a cara"

Fecha o separador. Mas a ideia fica-lhe na cabeça.

### 4. Encontro com o Mentor
Volta. Encontra o teste gratuito da Zona de Genialidade. Faz o assessment. O resultado diz-lhe exactamente o que deveria construir. Pela primeira vez, a ideia vaga tornou-se concreta. O Personagem Faceless é o mentor que nunca mostra a cara — mas mostra o caminho.

### 5. Travessia do Limiar
Compra o Blueprint por $29. Instala o Claude Code. Activa o PM. Escreve o primeiro prompt. O PM responde com perguntas estruturadas e em 45 minutos tem um PRD profissional. Pensa: "Espera... isto é real."

### 6. Provas, Aliados, Inimigos

| Tipo | O que acontece |
|------|---------------|
| **Prova** | O PRD está feito. Primeira vitória concreta |
| **Aliado** | O squad NOW OX — PM, Dev, Architect — responde, estrutura, constrói |
...
```
Frustração → Curiosidade → Dúvida → Descoberta → Medo
    → Acção → Choque ("isto funciona?!") → Orgulho
        → Identidade nova: "Eu sou founder"
```
