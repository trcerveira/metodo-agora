...
function Module7Content({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div><h3 className="text-now-green font-mono font-bold text-sm mb-2">PASSO 1 — Instalar os agentes</h3><BeginnerNote><strong className="text-now-green">Certifica-te que o Claude Code está aberto</strong> na pasta do teu projecto. Se não estiver: abre o terminal → <strong>cd o-meu-projecto</strong> → <strong>claude</strong> → Enter. O CLAUDE.md que criaste no módulo anterior já está lá — o Claude já sabe quem és.</BeginnerNote><p className="text-now-ivory/70 text-sm mb-3">Agora, dentro do Claude Code, cola este prompt:</p><TerminalBlock command="Instala os agentes PM e Analyst do Agora OX. Cria as pastas necessárias em .claude/commands/ com os ficheiros de configuração de cada agente." description="Instala os 2 agentes fundamentais" /></div>
...
function Module9Content({ onComplete }: { onComplete: () => void }) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div><h3 className="text-now-green font-mono font-bold text-sm mb-2">PASSO 1 — Activar o PM</h3><BeginnerNote><strong className="text-now-green">Abre o Claude Code</strong> na pasta do teu projecto (terminal → <strong>cd o-meu-projecto</strong> → <strong>claude</strong>). Quando o cursor estiver a piscar, escreve o comando abaixo. O <strong>/pm</strong> é um &quot;slash command&quot; — diz ao Claude para activar o agente Product Manager. É como chamar um colega de equipa.</BeginnerNote><TerminalBlock command="/pm" description="Activa o Product Manager" /></div>
